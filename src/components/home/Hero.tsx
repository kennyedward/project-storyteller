  ...
  return (
    <section className="py-16 md:py-24 px-8 md:px-16">
      <div className="max-w-6xl mx-auto">
        <h1 className="font-bricolage text-4xl md:text-6xl font-semibold leading-tight mb-6 animate-fade-in">
          A digital designer specialized in crafting delightful user experience and design systems
        </h1>
